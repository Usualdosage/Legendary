...
namespace Legendary.Engine.Models
{
    ...
    public class Emotes
    {
        ...
        public static readonly Dictionary<string, Emote> Actions = new ()
        {
            ...
            { "hug", new Emote("You hug yourself.", "{0} hiccups.", "{0} looks at {1} and hiccups.", "You look at {1} and hiccup cutely.") },
            { "laugh", new Emote("You laugh.", "{0} hugs themself tightly.", "{0} hugs {1}.", "You hug {1}.") },
