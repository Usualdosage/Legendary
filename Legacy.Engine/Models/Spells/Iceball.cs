...
namespace Legendary.Engine.Models.Spells
{
    ...
    public class Iceball : Spell
    {
        ...
        public Iceball(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, CombatProcessor combat)
            : base(communicator, random, world, logger, combat)
        {
            this.Name = "Iceball";
            this.ManaCost = 50;
            this.CanInvoke = true;
            this.DamageType = Core.Types.DamageType.Ice;
            this.IsAffect = false;
            this.AffectDuration = 0;
            this.HitDice = 3;
            this.DamageDice = 6;
            this.DamageModifier = 200;
            this.DamageNoun = "icy blast";
        }
