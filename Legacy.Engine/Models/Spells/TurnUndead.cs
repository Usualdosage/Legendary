...
namespace Legendary.Engine.Models.Spells
{
    ...
    public class TurnUndead : Spell
    {
        ...
        public TurnUndead(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, Combat combat)
        ...
        {
            var holySymbol = actor.Equipment.FirstOrDefault(e => e.ItemFlags.Contains(Core.Types.ItemFlags.Holy));
