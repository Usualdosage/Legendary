...
namespace Legendary.Engine.Models.SpellTrees
{
    ...
    public class WaterGroup : ActionTree
    {
        ...
        public WaterGroup(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, Combat combat)
        ...
        public override List<IAction> Group3
        {
            ...
            {
                { new Iceball(this.Communicator, this.Random, this.World, this.Logger, this.Combat) },
            };
        }
