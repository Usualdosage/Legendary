...
namespace Legendary.Engine.Models.SpellTrees
{
    ...
    public class FireGroup : ActionTree
    {
        ...
        public FireGroup(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, CombatProcessor combat)
        ...
        public override List<IAction> Group3
        {
            get => new ()
            {
                { new Fireball(this.Communicator, this.Random, this.World, this.Logger, this.CombatProcessor) },
            };
        }
