...
namespace Legendary.Engine.Models.SpellTrees
{
    ...
    public class DivineGroup : ActionTree
    {
        ...
        public DivineGroup(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, Combat combat)
        ...
        public override List<IAction> Group3
        {
            ...
            {
                { new TurnUndead(this.Communicator, this.Random, this.World, this.Logger,  this.Combat) },
            };
        }
