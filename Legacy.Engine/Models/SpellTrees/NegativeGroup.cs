...
namespace Legendary.Engine.Models.SpellTrees
{
    ...
    public class NegativeGroup : ActionTree
    {
        ...
        public NegativeGroup(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, CombatProcessor combat)
        ...
        public override List<IAction> Group2
        {
            get => new ()
            {
                { new Sleep(this.Communicator, this.Random, this.World, this.Logger,  this.CombatProcessor) },
            };
        }
        ...
        public override List<IAction> Group3
        {
            get => new ()
            {
                { new Silence(this.Communicator, this.Random, this.World, this.Logger,  this.CombatProcessor) },
            };
        }
        ...
        public override List<IAction> Group4
        {
            get => new ()
            {
                { new AcidBlast(this.Communicator, this.Random, this.World, this.Logger,  this.CombatProcessor) },
            };
        }
