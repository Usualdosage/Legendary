...
namespace Legendary.Engine.Models.Skills
{
    ...
    public class Sneak : Skill
    {
        ...
        public Sneak(ICommunicator communicator, IRandom random, IWorld world, ILogger logger, CombatProcessor combat)
        ...
        {
            await this.Communicator.SendToPlayer(actor, "You attempt to move silently.", cancellationToken);
